...
from .university_statistics import UniversityStatistics
from .university_content_section import UniversityContentSection
from .programme import Programme
from .programme_detail import ProgrammeDetail
from .programme_intake import ProgrammeIntake
from .programme_language_requirement import ProgrammeLanguageRequirement
from .programme_application_requirement import ProgrammeApplicationRequirement
