...
def test_is_cloudflare_block_detects_hard_block_markers():
    from src.tasks.crawl_programme_detail import is_cloudflare_block

    html = """
    <html><head><title>Attention Required! | Cloudflare</title></head>
    <body>Sorry, you have been blocked Cloudflare Ray ID: abc</body></html>
    """

    assert is_cloudflare_block(html) is True
    assert is_cloudflare_block("<html><title>Normal page</title></html>") is False
